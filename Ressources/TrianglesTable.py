...
result = """static const int _TriangleTable[12][256] =
{
"""
for triangle in TriangleTable:
	strTriangle = [str(triangle[i]) if i < len(triangle) else "-1" for i in range(12) ]
	result += "    {" + ", ".join(strTriangle) + " },\n"

result += """};
"""
print(result, len(TriangleTable))